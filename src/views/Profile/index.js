    ...
    <section class='profile'>
      ...
      <div>
        ...
        <div class='social'>
          ...
          <a href='https://twitter.com/kvartborg' target='_blank'><i class='fab fa-twitter' /></a>
          <a href='https://www.linkedin.com/in/kvartborg' target='_blank'><i class='fab fa-linkedin' /></a>
          <a href='https://instagram.com/frederik.kvartborg' target='_blank'><i class='fab fa-instagram' /></a>
        </div>
      </div>
    </section>
  </Layout>
